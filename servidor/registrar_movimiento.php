...
//La situacion indica si lo que sucedió: "entrada" si ingresó con éxito, "salida" si egregó con éxito.
...
$a = array("estado" => $estado, "mensaje" => $mensaje, "situacion" => $situacion);
