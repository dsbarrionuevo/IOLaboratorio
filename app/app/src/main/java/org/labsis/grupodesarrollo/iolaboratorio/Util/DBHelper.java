...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public boolean insertarUsuario(Usuario usuario) {
        ...
        //primero elimino lo que haya en la base de datos, solo permito un unico usuario
        db.beginTransaction();
        db.delete("usuario", "1", null);
        //ahora inserto el usuario
        ...
        db.endTransaction();
        boolean success = db.insert("usuario", null, cv) != -1;
        if (success) {
